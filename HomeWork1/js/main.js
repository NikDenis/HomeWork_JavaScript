...
alert(`${celsius} в градусах Цельсия равна: ${fahrenheit} в градусах по Фаренгейту.`);
console.log(`${celsius} в градусах Цельсия равна: ${fahrenheit} в градусах по Фаренгейту.`);
